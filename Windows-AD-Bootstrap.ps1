...
$certName = "*." + $domainName
$lifetime=Get-Date
$cert = New-SelfSignedCertificate -DnsName $certName -NotAfter $lifetime.AddDays(2*365) -KeyUsage DigitalSignature, KeyEncipherment -Type SSLServerAuthentication
